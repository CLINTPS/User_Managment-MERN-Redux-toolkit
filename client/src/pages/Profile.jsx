...
const Profile = () => {
  ...
  return (
      <div className="bg-cover bg-no-repeat h-screen" style={{backgroundImage: "url('https://images.pexels.com/photos/303383/pexels-photo-303383.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')"}}>
      <Navbar />
